...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM produtos WHERE dataInserido BETWEEN '$data_inicial' and '$data_final';";
...
<body>
    ...
    <div class="box">
        <form action="" method="POST">
            <fieldset>
                <legend><b>Relatório das Entradas</b></legend>
            ...
            if ((isset($data_inicial)) and (isset($data_final))) {
                echo (" <div class='botao1'> <a style='text-align:center' href='gerar_pdf.php?data_inicial=" . $data_inicial . "&data_final=" . $data_final . "'>GERAR PDF DA PESQUISA</a> <br> </div>");
            } else {
                echo (" <div class='botao2'> <a  href='gerar_pdf.php'>GERAR PDF DE TODOS</a> <br> </div>");
            }
